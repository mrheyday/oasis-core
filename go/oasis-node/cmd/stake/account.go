...
func doAccountTransfer(cmd *cobra.Command, args []string) {
	...
	if err := xfer.BaseUnits.UnmarshalText([]byte(viper.GetString(CfgAmount))); err != nil {
...
func doAccountBurn(cmd *cobra.Command, args []string) {
	...
	if err := burn.BaseUnits.UnmarshalText([]byte(viper.GetString(CfgAmount))); err != nil {
...
func doAccountEscrow(cmd *cobra.Command, args []string) {
	...
	if err := escrow.BaseUnits.UnmarshalText([]byte(viper.GetString(CfgAmount))); err != nil {
